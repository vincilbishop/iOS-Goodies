...
@interface IOGModalPickerBase ()



@end

@implementation IOGModalPickerBase
...
- (UIView *)picker {
    if (!_picker) {
        CGRect pickerFrame = CGRectMake(0,
                                        IOGMODALPICKER_TOOLBAR_HEIGHT,
                                        self.bounds.size.width,
                                        IOGMODALPICKER_PANEL_HEIGHT - IOGMODALPICKER_TOOLBAR_HEIGHT);
...
- (UIToolbar *)toolbar {
    if (!_toolbar) {
        _toolbar = [[UIToolbar alloc] initWithFrame:CGRectMake(0, 0, self.bounds.size.width, IOGMODALPICKER_TOOLBAR_HEIGHT)];
...
- (UIView *)backdropView {
    if (!_backdropView) {
        ...
        _backdropView.backgroundColor = [UIColor colorWithWhite:0 alpha:IOGMODALPICKER_BACKDROP_OPACITY];
...
- (void)presentInView:(UIView *)view {
    ...
    self.panel = [[UIView alloc] initWithFrame:CGRectMake(0, self.bounds.size.height - IOGMODALPICKER_PANEL_HEIGHT, self.bounds.size.width, IOGMODALPICKER_PANEL_HEIGHT)];
